...
const Pagination = ({pages, setCurrentPage, currentLaunches, launches}) => {
    ...
    return (
        ...
        <div className="hint-text text-center mb-4">Showing <b>{currentLaunches.length}</b> out of <b>{launches.length}</b> entries</div>
